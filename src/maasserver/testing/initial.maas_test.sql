...
CREATE TABLE public.maasserver_agent (
    ...
    rackcontroller_id bigint NOT NULL
);
...
--
-- Name: maasserver_agentcertificate; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.maasserver_agentcertificate (
    id bigint NOT NULL,
...
--
-- Name: maasserver_agentcertificate_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.maasserver_agentcertificate ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.maasserver_agentcertificate_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
COPY public.maasserver_agent (id, created, updated, secret, rack_id, rackcontroller_id) FROM stdin;
\.
...
1	2025-09-04 13:01:35.555237+00	2025-09-04 13:01:35.555237+00	1
\.
...
1	1	2025-09-04 13:01:35.555237+00	Initial publication
\.
...
0	2025-09-04 13:01:35.555237+00	2025-09-04 13:01:35.555237+00	maas	t	\N
\.
...
1	2025-09-04 13:01:35.555237+00	2025-09-04 13:01:35.555237+00	main_archive	http://archive.ubuntu.com/ubuntu	{}	{amd64,i386}		t	t	{}	{}	{}	t
2	2025-09-04 13:01:35.555237+00	2025-09-04 13:01:35.555237+00	ports_archive	http://ports.ubuntu.com/ubuntu-ports	{}	{armhf,arm64,ppc64el,s390x}		t	t	{}	{}	{}	t
\.
...
0	2025-09-04 13:01:35.555237+00	2025-09-04 13:01:35.555237+00	default	Default pool
\.
...
1	2025-09-04 13:01:35.555237+00	2025-09-04 13:01:35.555237+00	default
\.
...
0	2025	9	2025-09-04 13:01:36.037314	initial version		0.0	0
0	2025	9	2025-09-04 13:01:36.076843	base version of schema	55b84ca114ac34d84bdc5f52c198fa33	1.0	0.0
0	2025	9	2025-09-04 13:01:36.077443	schema update for cluster metadata	58f06841bbb187cb210db32a090c21ee	1.1	1.0
0	2025	9	2025-09-04 13:01:36.077822	schema update for RPC replication	c6bdeea21882e2625038927a84929b16	1.2	1.1
0	2025	9	2025-09-04 13:01:36.078541	schema update for kafka deprecation	3beee7d470421674194475f94b58d89b	1.3	1.2
0	2025	9	2025-09-04 13:01:36.078939	schema update for cluster metadata cleanup	c53e2e9cea5660c8a1f3b2ac73cdb138	1.4	1.3
0	2025	9	2025-09-04 13:01:36.079642	schema update for cluster_membership, executions and history_node tables	bfb307ba10ac0fdec83e0065dc5ffee4	1.5	1.4
0	2025	9	2025-09-04 13:01:36.080128	schema update for queue_metadata	978e1a6500d377ba91c6e37e5275a59b	1.6	1.5
0	2025	9	2025-09-04 13:01:36.08165	create cluster metadata info table to store cluster information and executions to store tiered storage queue	366b8b49d6701a6a09778e51ad1682ed	1.7	1.6
0	2025	9	2025-09-04 13:01:36.082769	drop unused tasks table; Expand VARCHAR columns governed by maxIDLength to VARCHAR(255)	229846b5beb0b96f49e7a3c5fde09fa7	1.8	1.7
0	2025	9	2025-09-04 13:01:36.084059	add history tasks table	b62e4e5826967e152e00b75da42d12ea	1.9	1.8
0	2025	9	2025-09-04 13:01:36.085346	add storage for update records and create task_queue_user_data table	2b0c361b0d4ab7cf09ead5566f0db520	1.10	1.9
0	2025	9	2025-09-04 13:01:36.08667	add queues and queue_messages tables	790ad04897813446f2953f5bd174ad9e	1.11	1.10
0	2025	9	2025-09-04 13:01:36.087812	add storage for Nexus incoming service records and create nexus_incoming_services and nexus_incoming_services_partition_status tables	9a9c378fc124da5a172f8229872bd24c	1.12	1.11
\.
...
0	maas	2025-09-04 13:01:36.087694	1.12	1.0
\.
...
0	2025	9	2025-09-04 13:01:36.049429	initial version		0.0	0
0	2025	9	2025-09-04 13:01:36.103008	base version of visibility schema	6a739dc4ceb78e29e490cd7cef662a80	1.0	0.0
0	2025	9	2025-09-04 13:01:36.103598	add close time & status index	3bc835a57de6e863cf545c25aa418aa3	1.1	1.0
0	2025	9	2025-09-04 13:01:36.134212	update schema to support advanced visibility	3943d27399fe3df0f1be869a4982c0bb	1.2	1.1
0	2025	9	2025-09-04 13:01:36.141436	add history size bytes and build IDs visibility columns and indices	62928bdd9093a8c18bb4a39bfe8e3a22	1.3	1.2
0	2025	9	2025-09-04 13:01:36.143124	add execution duration, state transition count and parent workflow info columns, and indices	c28266b8b78448f2fefb507a74c7dcdf	1.4	1.3
0	2025	9	2025-09-04 13:01:36.144352	add root workflow info columns and indices	f8da72ec53ef81b85988465e08b20319	1.5	1.4
0	2025	9	2025-09-04 13:01:36.145931	fix root workflow info columns	0cf22b219b64b4c76988c616e2c776de	1.6	1.5
\.
...
0	maas	2025-09-04 13:01:36.145828	1.6	0.1
\.
...
--
-- Name: maasserver_agentcertificate_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.maasserver_agentcertificate_id_seq', 1, false);
...
--
-- Name: maasserver_agent maasserver_agent_secret_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maasserver_agent
    ADD CONSTRAINT maasserver_agent_secret_key UNIQUE (secret);


--
-- Name: maasserver_agentcertificate maasserver_agentcertificate_certificate_fingerprint_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maasserver_agentcertificate
    ADD CONSTRAINT maasserver_agentcertificate_certificate_fingerprint_key UNIQUE (certificate_fingerprint);


--
-- Name: maasserver_agentcertificate maasserver_agentcertificate_certificate_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maasserver_agentcertificate
    ADD CONSTRAINT maasserver_agentcertificate_certificate_key UNIQUE (certificate);


--
-- Name: maasserver_agentcertificate maasserver_agentcertificate_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maasserver_agentcertificate
    ADD CONSTRAINT maasserver_agentcertificate_pkey PRIMARY KEY (id);
...
--
-- Name: maasserver_agentcertificate maasserver_agentcertificate_agent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maasserver_agentcertificate
    ADD CONSTRAINT maasserver_agentcertificate_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.maasserver_agent(id);
