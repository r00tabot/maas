...
--
-- Name: maasserver_usergroup; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.maasserver_usergroup (
    id bigint NOT NULL,
    created timestamp with time zone NOT NULL,
    updated timestamp with time zone NOT NULL,
    name character varying(256) NOT NULL,
...
--
-- Name: maasserver_usergroup_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.maasserver_usergroup ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.maasserver_usergroup_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: maasserver_usergroup_members_view; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.maasserver_usergroup_members_view AS
 SELECT (t.object_id)::integer AS group_id,
    u.id,
    u.username,
    u.email
   FROM (openfga.tuple t
     JOIN public.auth_user u ON ((u.id = (split_part(t._user, ':'::text, 2))::integer)))
  WHERE ((t.object_type = 'group'::text) AND (t.relation = 'member'::text) AND (t.user_type = 'user'::text));
...
1	0	t	2026-02-27 12:48:13.027603
2	1	t	2026-02-27 12:48:13.029035
3	2	t	2026-02-27 12:48:13.031245
\.
...
1	0	t	2026-02-27 12:48:13.007115
2	1	t	2026-02-27 12:48:13.009436
3	2	t	2026-02-27 12:48:13.013147
4	3	t	2026-02-27 12:48:13.013477
5	4	t	2026-02-27 12:48:13.013961
6	5	t	2026-02-27 12:48:13.01413
7	6	t	2026-02-27 12:48:13.015471
\.
...
00000000000000000000000000	MAAS	2026-02-27 12:48:13.029035+00	2026-02-27 12:48:13.029035+00	\N
\.
...
00000000000000000000000000	pool	0	parent	maas:0	user	01KJFJ8XQ7DQSY256RVCWBF2RW	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_edit_machines	group:1#member	userset	01KJFJ8XQ8ZGJASX7YX6HFGTQY	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_edit_global_entities	group:1#member	userset	01KJFJ8XQ8ZGJASX7YX6PJ4Q3B	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_edit_controllers	group:1#member	userset	01KJFJ8XQ8ZGJASX7YX9EN9KKQ	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_edit_identities	group:1#member	userset	01KJFJ8XQ8ZGJASX7YXAKRRK0Y	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_edit_configurations	group:1#member	userset	01KJFJ8XQ8ZGJASX7YXBJ1E1RC	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_edit_notifications	group:1#member	userset	01KJFJ8XQ8ZGJASX7YXFG5FWWH	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_edit_boot_entities	group:1#member	userset	01KJFJ8XQ8ZGJASX7YXHJZDXEQ	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_edit_license_keys	group:1#member	userset	01KJFJ8XQ8ZGJASX7YXMJ51J35	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_view_devices	group:1#member	userset	01KJFJ8XQ8ZGJASX7YXQC8SMD2	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_view_ipaddresses	group:1#member	userset	01KJFJ8XQ8ZGJASX7YXSVZXPTA	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_deploy_machines	group:2#member	userset	01KJFJ8XQ8ZGJASX7YXT5JZMYF	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_view_deployable_machines	group:2#member	userset	01KJFJ8XQ8ZGJASX7YXVA0RAFK	2026-02-27 12:48:13.031245+00	\N	\N
00000000000000000000000000	maas	0	can_view_global_entities	group:2#member	userset	01KJFJ8XQ8ZGJASX7YXVH02BWV	2026-02-27 12:48:13.031245+00	\N	\N
\.
...
--
-- Data for Name: maasserver_usergroup; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.maasserver_usergroup (id, created, updated, name, description) FROM stdin;
1	2026-02-27 12:48:12.946997+00	2026-02-27 12:48:12.946997+00	Administrators	Default administrators group
2	2026-02-27 12:48:12.946997+00	2026-02-27 12:48:12.946997+00	Users	Default users group
\.
...
--
-- Name: maasserver_usergroup_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.maasserver_usergroup_id_seq', 2, true);
...
--
-- Name: maasserver_usergroup maasserver_usergroup_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maasserver_usergroup
    ADD CONSTRAINT maasserver_usergroup_name_key UNIQUE (name);


--
-- Name: maasserver_usergroup maasserver_usergroup_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maasserver_usergroup
    ADD CONSTRAINT maasserver_usergroup_pkey PRIMARY KEY (id);
...
--
-- Name: maasserver_usergroup_name_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX maasserver_usergroup_name_idx ON public.maasserver_usergroup USING btree (name);
