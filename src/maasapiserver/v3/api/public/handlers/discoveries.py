...
from maasapiserver.common.api.models.responses.errors import NotFoundBodyResponse, NotFoundResponse
from maasapiserver.v3.api import services
from maasapiserver.v3.api.public.models.requests.query import PaginationParams
from maasapiserver.v3.api.public.models.responses.base import OPENAPI_ETAG_HEADER
...
class DiscoveriesHandler(Handler):
    ...
    async def get_discovery(
        ...
        return DiscoveryResponse.from_model(
            discovery=discovery, self_base_hyperlink=f"{V3_API_PREFIX}/discoveries"
        )
