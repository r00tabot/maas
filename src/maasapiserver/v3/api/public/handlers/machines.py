        ...
        if authenticated_user.rbac_permissions:
            ...
            where_clause = MachineClauseFactory.or_clauses(
                [
                    MachineClauseFactory.with_resource_pool_ids(
                        set(
                            await services.openfga_tuples.get_client().list_pools_with_view_machines_access(
                    ...
                    MachineClauseFactory.and_clauses(
                        [
                            ...
                            MachineClauseFactory.with_resource_pool_ids(
                                set(
                                    await services.openfga_tuples.get_client().list_pools_with_view_available_machines_access(
                                        authenticated_user.id
                                    )
                                )
                            ),
