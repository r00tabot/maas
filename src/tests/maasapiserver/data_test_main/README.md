# How to generate the certificates in this folder i.e. for the tests of src/tests/maasapiserver/test_main.py

From the current directory, you can execute the following script 
...
openssl x509 -req -in "$FAKE_CLIENT_CSR" \
    ...
    -out "$FAKE_CLIENT_CERT" -days 1 -sha256
