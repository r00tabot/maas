...
from maasapiserver.v3.api.public.models.responses.discoveries import DiscoveryResponse
import pytest
...
class TestDiscoveriesApi(ApiCommonTests):
    ...
    async def test_get_by_id(
        ...
        assert discovery_response.discovery_id =="MTAuMTAuMC4yOSwwMDoxNjozZToyOTphNTphMQ=="
