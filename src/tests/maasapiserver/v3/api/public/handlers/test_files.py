...
class TestFilesApi(ApiCommonTests):
    ...
    async def test_create_file_empty_file(
        self,
        services_mock: ServiceCollectionV3,
        mocked_api_client_user: AsyncClient,
    ) -> None:
    ...
    async def test_create_file_no_file(
        self,
        services_mock: ServiceCollectionV3,
        mocked_api_client_user: AsyncClient,
    ) -> None:
        # This is handled by httpx as it's an invalid body
        file_name = "test.bin"
    ...
    async def test_create_file_no_filename_422(
        self,
        services_mock: ServiceCollectionV3,
        mocked_api_client_user: AsyncClient,
    ) -> None:
        file_data = self.create_dummy_binary_upload_file(size_in_bytes=1)
