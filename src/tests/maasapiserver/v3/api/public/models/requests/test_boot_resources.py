...
class TestBootResourceCreateRequest:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            BootResourceFileTypeChoice.TBZ,
            BootResourceFileTypeChoice.TXZ,
            BootResourceFileTypeChoice.DDTGZ,
            BootResourceFileTypeChoice.DDRAW,
            BootResourceFileTypeChoice.DDTAR,
        ],
    )
