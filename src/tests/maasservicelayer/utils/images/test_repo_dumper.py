...
class TestRepoDumper:
    ...
    def test_insert_item_adds_item_per_subarch(
        self,
        products_exdata_mock: MagicMock,
    ) -> None:
        ...
        products_exdata_mock.return_value = item
    ...
    def test_insert_item_sets_compat_item_specific_to_subarch(
        ...
        products_exdata_mock.side_effect = [
            item,
            second_item,
        ]
    ...
    def test_sync_does_propagate_ioerror(
        self,
        mirror_writer_sync_mock: MagicMock,
    ) -> None:
        io_error = factory.make_exception_type(bases=(IOError,))

        mirror_writer_sync_mock.side_effect = io_error()
