...
from maasservicelayer.services.base import BaseService, ViewService


@pytest.mark.asyncio
class ViewServiceCommonTests(abc.ABC):
    @pytest.fixture
    @abc.abstractmethod
    def service_instance(self) -> ViewService:
        pass
...
@pytest.mark.asyncio
class ServiceCommonTests(ViewServiceCommonTests):
    @pytest.fixture
    @abc.abstractmethod
